...
export default {
  ...
  // Button
  buttonFontFamily: platform === PLATFORM.IOS ? 'System' : 'Lato',
  ...
  // Color
  brandPrimary: platform === PLATFORM.IOS ? '#3AAFA9' : '#3AAFA9',
  brandInfo: '#62B1F6',
  brandSuccess: '#5cb85c',
  brandDanger: '#d9534f',
  brandWarning: '#f0ad4e',
  ...
  // Font
  DefaultFontSize: 16,
  fontFamily: platform === PLATFORM.IOS ? 'System' : 'Lato',
  fontSizeBase: 15,
  get fontSizeH1() {
  ...
  // Title
  titleFontfamily: platform === PLATFORM.IOS ? 'System' : 'Lato',
